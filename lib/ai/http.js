import { runDuplicateCheck, runOnboardingAssistant, runPriorityExplanation, runTitleSummary } from "./service.js";
...
export async function resolveAiRoute(routeName, payload, options = {}) {
  switch (routeName) {
    ...
    case "onboarding-assistant":
      return runOnboardingAssistant(payload, options);
    default:
